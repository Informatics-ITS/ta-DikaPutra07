...
from models import Uautoformer, UautoformerC1, UautoformerC2, Uautoformer2, Transformer, Reformer, Mantra, MantraV1, MantraA, MantraB, MantraD, MantraE, FRNet, Autoformer2
from utils.tools import EarlyStopping, adjust_learning_rate, visual, adjust_learning_rate_adapative_clr
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(vali_loader):
                ...
                if self.args.use_amp:
                    with torch.cuda.amp.autocast():
                        if 'B6iFast' or 'FRNet' in self.args.model:
